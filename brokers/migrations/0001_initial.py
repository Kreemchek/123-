    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('services', models.JSONField(default=list, help_text='Список предоставляемых услуг', verbose_name='Услуги')),
                ('specializations', models.JSONField(default=list, help_text='Список специализаций', verbose_name='Специализация')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_amount', models.DecimalField(decimal_places=2, default=1.0, max_digits=10)),
